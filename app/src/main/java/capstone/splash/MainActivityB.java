...
public class MainActivityB extends AppCompatActivity {
    ...
    private void rotate(double difference){
        ...
        if(difference>0){
            ((BaseApplication) getApplicationContext()).turnX((int)(directionChoice*difference*6.1+5));
        }else{
            ((BaseApplication) getApplicationContext()).turnX((int)(directionChoice*difference*4-3));
        }
    }
    ...
    private void doneTuning(){
        ...
        updateImage();
        Intent i_auto = new Intent(MainActivityB.this, MainActivityE.class);
        Intent i_main = new Intent(MainActivityB.this, MainActivity.class);
        try {
            sleep(1000);
