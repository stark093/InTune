...
public class MainActivityD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        desiredFrequency = ((BaseApplication) getApplicationContext()).getFrequency(4);
    ...
    private void rotate(double difference){
        ...
        if(difference>0){
            ((BaseApplication) getApplicationContext()).turnX((int)(directionChoice*difference*20.1+0));
        }else{
    ...
    private void doneTuning(){
        ...
        updateImage();
        Intent i_auto = new Intent(MainActivityD.this, MainActivityG.class);
        Intent i_main = new Intent(MainActivityD.this, MainActivity.class);
        try {
            sleep(1000);
