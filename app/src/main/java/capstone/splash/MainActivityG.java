...
public class MainActivityG extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        desiredFrequency = ((BaseApplication) getApplicationContext()).getFrequency(3);
    ...
    private void doneTuning(){
        ...
        updateImage();
        Intent i_auto = new Intent(MainActivityG.this, MainActivityB.class);
        Intent i_main = new Intent(MainActivityG.this, MainActivity.class);
        try {
            sleep(1000);
